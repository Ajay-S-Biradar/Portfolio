...
const HomeDividerLine = () => {
  ...
  return (
    ...
    >
            ...
            >
              <div className='flex'>
                <div className='flex h-[40vh] w-60 md:w-auto md:h-96 gap-3 flex-col justify-center md:items-start border md:border-r-0 border-[#fcf6f4] text-[#fcf6f4] px-2 md:p-6'>
